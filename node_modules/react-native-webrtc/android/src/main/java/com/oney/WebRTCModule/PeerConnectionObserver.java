...
import org.webrtc.OctonFrameDecryptor;
import org.webrtc.OctonFrameEncryptor;
...
class PeerConnectionObserver implements PeerConnection.Observer {
    ...
    boolean addStream(MediaStream localStream) {
        if (peerConnection != null && peerConnection.addStream(localStream)) {
            ...
            // Added by Ivan
            peerConnection.setFrameEncryptor(new OctonFrameEncryptor());
            return true;
        }
    ...
    public void onIceCandidate(final IceCandidate candidate) {
        ...
        // Added by Ivan
        if (peerConnection != null) {
            peerConnection.setFrameDecryptor(new OctonFrameDecryptor());
        }
    }
    ...
    public void onAddTrack(final RtpReceiver receiver, final MediaStream[] mediaStreams) {
        ...
        // Added by Ivan
        // receiver.setFrameDecryptor(new OctonFrameDecryptor());
        // Log.d(TAG, "onAddOctonFrameDecryptor");
